if (Meteor.isClient) {
	...
	// 	//Uses http://plugins.telerik.com/cordova/plugin/native-page-transitions

	// 	//Known issues:
	// 	//Hardware back button on Android doesn't back out of app - need to keep history state in order to do that
	// 	//Sam issue means that if you click hardware back button on the last page, the next transition is the back transition
	...
	// nativeTransition = function(completed) {
	// 	if (Meteor.isCordova) {
