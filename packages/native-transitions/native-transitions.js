...
//Slow down factor (overlap)
nt.defaults.slowdownfactor = 4;

//Slide pixes
nt.defaults.slidePixels = 0;
...
nt.transition = function(options) {
	...
	if (isAndroid && nt.disableAndroid) return;
	...
	if (Meteor.isCordova) {
		...
		Meteor.defer(function() {
			...
			var theseOptions = {
						   ...
						   "slidePixels"    :   mergedOptions.slidePixels, // optional, works nice with slowdownfactor -1 to create a 'material design'-like effect. Default not set so it slides the entire page
